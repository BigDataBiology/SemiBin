...
def parse_args(args):
    ...
    for p in [single_easy_bin, binning]:
        p.add_argument('--depth-metabat2',
                       required=False,
                       type=str,
                       help='depth file generated by metabat2 (single-sample binning)',
                       dest='depth_metabat2',
                       default=None,
                       )
...
def single_easy_binning(args, logger, binned_length,
                        must_link_threshold,
                        contig_dict, recluster,random_seed, output, device, environment, orf_finder = 'prodigal', depth_metabat2 = None):
    """
