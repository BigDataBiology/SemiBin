...
def train(out,contig_fasta,binned_short,logger,data,data_split,cannot_link,is_combined = True,
    ...
    cal_num_bins(contig_fasta,contig_output,hmm_output,seed_output,binned_short)
    ...
    train_loader_unlabeled = DataLoader(dataset=dataset_unlabeled, batch_size=batchsize, shuffle=True, num_workers=16)
